         ...
         <div class="card-body">
           <div>
            <div class="d-flex justify-content-between py-2">
              <h3>Customer List</h3>
<Link class="start-btn btn btn-success"  :href="`/category-save/${id}`">Customer Create</Link>
</div>
             <input placeholder="Search..." class="form-control mb-2 w-auto form-control-sm" type="text" v-model="searchValue">
               ...
               <template #item-number="{ id,player }">
                 <Link class="btn btn-success mx-3 btn-sm" :href="`/customer-save/?id=${id}`" >Edit</Link>
